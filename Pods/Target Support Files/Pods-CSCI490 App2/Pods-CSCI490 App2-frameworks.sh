...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-CSCI490 App2/Bolts.framework"
  install_framework "Pods-CSCI490 App2/FBSDKCoreKit.framework"
  install_framework "Pods-CSCI490 App2/FBSDKLoginKit.framework"
